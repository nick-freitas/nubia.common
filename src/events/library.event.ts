...
export const isGetUserLibraryEvent = (
  e: NubiaEvent
): e is GetUserLibraryEvent => e.type === LibraryEventType.GET_USER_LIBRARY;
...
export const isAddBookToLibraryEvent = (
  e: NubiaEvent
): e is AddBookToLibraryEvent =>
  e.type === LibraryEventType.ADD_BOOK_TO_LIBRARY;
...
export const isRemoveBookFromLibraryEvent = (
  e: NubiaEvent
): e is RemoveBookFromLibraryEvent =>
  e.type === LibraryEventType.REMOVE_BOOK_FROM_LIBRARY;
